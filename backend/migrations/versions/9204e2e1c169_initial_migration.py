...
def upgrade():
    ...
    op.execute('DROP TABLE IF EXISTS contact_inquiry CASCADE')
    ...
    op.execute('DROP TABLE IF EXISTS newsletter_subscriber CASCADE')
    ...
    op.execute('DROP TABLE IF EXISTS project_image CASCADE')
    ...
    op.execute('DROP TABLE IF EXISTS project_metric CASCADE')
